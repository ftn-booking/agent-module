    ...
    Imgur.prototype = {
        ...
        createDragZone: function () {
            var p1, p2, input;
                ...
                p2 = this.createEls('p', {}, 'Click here to select images');
            input = this.createEls('input', {type: 'file', id:'input', className: 'input', accept: 'image/*', multiple: 'multiple'});
        ...
        loading: function () {
            ...
            //img = this.createEls('img', {className: 'loading-image', type: 'hidden', src: './css/loading-spin.svg'});
